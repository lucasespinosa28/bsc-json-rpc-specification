...
#[derive(Serialize, Deserialize)]
pub enum  {
    Data,
    Transaction,
    BlockNumberOrTag,
    Address,
...
jsonrpc_client!(pub struct BinanceSmartChainJSONRPCSpecification {
...
pub fn EthGetTransactionsByBlockNumber(&mut self, blockNumber: BlockNumberOrTag) -> RpcRequest<TransactionOrNull>;
pub fn EthGetTransactionReceiptsByBlockNumber(&mut self, blockNumber: BlockNumberOrTag) -> RpcRequest<Receipt>;
pub fn EthGetTransactionByHash(&mut self, transactionHash: TransactionHash) -> RpcRequest<TransactionOrNull>;
pub fn EthGetTransactionDataAndReceipt(&mut self, transactionHash: TransactionHash) -> RpcRequest<Receipt>;
